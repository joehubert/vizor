...
import type { OneTimeExpenseModel } from '../../types/models';

interface Props {
  model: OneTimeExpenseModel;
  onSave: (model: OneTimeExpenseModel) => void;
  onDelete?: () => void;
  onCancel: () => void;
}

export default function OneTimeExpenseForm({ model, onSave, onDelete, onCancel }: Props) {
